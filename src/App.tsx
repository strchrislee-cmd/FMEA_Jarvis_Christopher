...
export default function App() {
  const fmea = useFmea()
  const { project, currentStep, updateMeta, goTo, importProject, newProject } = fmea
  ...
  return (
    <div className="flex h-screen flex-col bg-white text-gray-900">
      <Toolbar project={project} onMeta={updateMeta} onImport={importProject} onNew={newProject} />
